...
[
    ...
    },
    {
        name: 'Smith',
        image:`${smith}`,
        description:'Seguindo o conceito de arquitetura em  camadas MSC, utilizei Typescript para desenvolver as funcionalidades da aplicação, deixando o código mais prático para realizar manutenções, passei a utilizar JOI para as devidas validações em middlewares',
